...
## Purpose
Proporcionar componentes de skeleton (placeholder animado) para todas las vistas de la aplicación, evitando texto "Cargando..." y mejorando la percepción de velocidad con transiciones suaves.
