...
## Purpose
Sistema de notificaciones toast global para la aplicación, utilizando `react-toastify`, que proporciona feedback visual consistente para acciones del usuario (éxito, error, advertencia, informativo).
