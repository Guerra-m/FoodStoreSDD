...
## Purpose
Página de confirmación de pedido que se muestra después de una creación exitosa, proporcionando al usuario un resumen visual del pedido, detalles de entrega y acciones para continuar.
