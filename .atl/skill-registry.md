...
- .opencode/skills
- /home/noguedev/.config/opencode/skills
...
### branch-pr
- Path: /home/noguedev/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/noguedev/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/noguedev/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-code
- Path: /home/noguedev/FoodStoreSDD/.opencode/skills/comment-code/SKILL.md
- Trigger: >
- Rules:
...
### comment-writer
- Path: /home/noguedev/.config/opencode/skills/comment-writer/SKILL.md
...
### dashboard-crud-page
- Path: /home/noguedev/FoodStoreSDD/.opencode/skills/dashboard-crud-page/SKILL.md
- Trigger: >
- Rules:
  - Need: Hook
  - Modal state + form data: `useFormModal<FormData, Entity>`
  - Delete confirmation state: `useConfirmDialog<Entity>`
  - Pagination: `usePagination(sortedItems)`
...
- Path: /home/noguedev/FoodStoreSDD/.opencode/skills/frontend-architecture/SKILL.md
- Trigger: >
- Rules:
...
### go-testing
- Path: /home/noguedev/.config/opencode/skills/go-testing/SKILL.md
...
### issue-creation
- Path: /home/noguedev/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/noguedev/.config/opencode/skills/judgment-day/SKILL.md
...
- Path: /home/noguedev/FoodStoreSDD/.opencode/skills/openspec-apply-change/SKILL.md
- Trigger: Implement tasks from an OpenSpec change. Use when the user wants to start implementing, continue implementation, or work through tasks.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### openspec-archive-change
- Path: /home/noguedev/FoodStoreSDD/.opencode/skills/openspec-archive-change/SKILL.md
- Trigger: Archive a completed change in the experimental workflow. Use when the user wants to finalize and archive a change after implementation is complete.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### openspec-explore
- Path: /home/noguedev/FoodStoreSDD/.opencode/skills/openspec-explore/SKILL.md
- Trigger: Enter explore mode - a thinking partner for exploring ideas, investigating problems, and clarifying requirements. Use when the user wants to think through something before or during a change.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### openspec-propose
- Path: /home/noguedev/FoodStoreSDD/.opencode/skills/openspec-propose/SKILL.md
- Trigger: Propose a new change with all artifacts generated in one step. Use when the user wants to quickly describe what they want to build and get a complete proposal with design, specs, and tasks ready for implementation.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### react-frontend-vite
- Path: /home/noguedev/FoodStoreSDD/.opencode/skills/react-frontend-vite/SKILL.md
- Trigger: >
- Rules:
...
### skill-creator
- Path: /home/noguedev/.config/opencode/skills/skill-creator/SKILL.md
...
- Path: /home/noguedev/FoodStoreSDD/.opencode/skills/tailwind-design-system/SKILL.md
...
### work-unit-commits
- Path: /home/noguedev/.config/opencode/skills/work-unit-commits/SKILL.md
