...
def upgrade() -> None:
    ...
    op.create_table('pedido',
        ...
        sa.Column('direccion_snapshot', sqlmodel.sql.sqltypes.JSON(), nullable=False),
    ...
    op.create_table('pedido_item',
        ...
        sa.Column('producto_snapshot', sqlmodel.sql.sqltypes.JSON(), nullable=False),
        sa.Column('cantidad', sa.Integer(), nullable=False),
        sa.Column('precio_unitario', sa.Integer(), nullable=False),
        sa.Column('ingredientes_excluidos', sqlmodel.sql.sqltypes.JSON(), nullable=False),
